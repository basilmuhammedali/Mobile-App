<%@ Page Title="devam eden faturalar" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="BillsHold.aspx.vb" Inherits="BillsHold" %>
    ...
    <table cellpadding="2" class="style4">
        <tr>
            <td align="center" bgcolor="#F3E9ED">
                faturalar listesi / siparişler işleniyor</td>
        </tr>
        <tr>
            <td align="center" bgcolor="#F3E9ED">
                <asp:Button ID="Button1" runat="server" 
                    style="font-size: medium; font-family: Tahoma" 
                    Text=" fatura oluşturmak için / yeni sipariş buraya tıklayın " Width="326px" />
            </td>
        </tr>
        <tr>
            <td align="right" bgcolor="White" style="direction: rtl">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    EmptyDataText="şu anda fatura yok" 
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" 
                                    ...
                                    onclientclick="return confirm('Gerçekten silmek istiyormusunuz')" Text="sil ve iptal et"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink9" runat="server" Font-Underline="False" 
                                    NavigateUrl='<%# Eval("BillsID", "BillsView.aspx?BillsID={0}") %>'>içeriği görüntüleyin</asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
