<%@ Page Title="Değişiklik" Language="VB" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="false" CodeFile="MealsEdit.aspx.vb" Inherits="Admin_MealsEdit" %>
    ...
    <table cellpadding="2" class="style2">
        <tr>
            <td align="center" bgcolor="#F4F4F4">
                <asp:Label ID="Lbmsg" runat="server" Text="Telefon modifikasyonu"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table cellpadding="2">
                    <tr>
                        ...
                        <td>
                            <asp:Image ID="Image1" runat="server" BorderColor="#009900" 
                                BorderStyle="Dotted" BorderWidth="1px" Height="143px" Width="156px" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td align="center">
                <asp:Button ID="Button1" runat="server" Font-Size="Large" 
                    style="font-family: Tahoma" Text="kayıdet" Width="118px" />
            </td>
        </tr>
    </table>
</asp:Content>
