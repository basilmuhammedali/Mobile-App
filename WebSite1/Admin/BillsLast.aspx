<%@ Page Title="Bekleyen faturalar ve Siparişler" Language="VB" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="false" CodeFile="BillsLast.aspx.vb" Inherits="Admin_BillsHold" %>
    ...
    <table cellpadding="2" class="style2">
        <tr>
            <td align="center" bgcolor="#F4F4F4">
                <asp:Label ID="Lbmsg" runat="server" Text="Önceki siparişler ve faturalar-tamamlandı"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td align="right">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    EmptyDataText="Şu anda sipariş yok" EnableModelValidation="True">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink11" runat="server" Font-Underline="False" 
                                    ...
                                    style="color: #FF0000">تفاصيل</asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
